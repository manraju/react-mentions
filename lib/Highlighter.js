...
var Highlighter = (_temp = _class = function (_Component) {
  ...
  Highlighter.prototype.render = function render() {
    ...
    if (selection.start === selection.end) {
      caretPositionInMarkup = (0, _utils.mapPlainTextIndex)(value, config, selection.start, 'START');
    }
    ...
    (0, _utils.iterateMentionsMarkup)(value, config, mentionIteratee, textIteratee);
  ...
  Highlighter.prototype.getMentionComponentForMatch = function getMentionComponentForMatch(id, display, mentionChildIndex, key) {
    ...
    var child = _react.Children.toArray(this.props.children)[mentionChildIndex];
