...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactMentions"] = factory();
	else
		root["ReactMentions"] = factory();
})(window, function() {
...
var _createSubstyle = __webpack_require__(62);

var _createSubstyle2 = _interopRequireDefault(_createSubstyle);

var _defaultStyle = __webpack_require__(175);

var _defaultStyle2 = _interopRequireDefault(_defaultStyle);

var _EnhancerProvider = __webpack_require__(180);

var _EnhancerProvider2 = _interopRequireDefault(_EnhancerProvider);

var _defaultPropsDecorator = __webpack_require__(63);
...
var _pickStyles = __webpack_require__(64);

var _filterKeys = __webpack_require__(65);

var _coerceSelection = __webpack_require__(66);
...
*/
var aa=__webpack_require__(1),n=__webpack_require__(38),r=__webpack_require__(74);function ba(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[c,d,e,f,g,h],k=0;a=Error(b.replace(/%s/g,function(){return l[k++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var isPlainObject = __webpack_require__(151);
...
var values = __webpack_require__(68);
var values_default = /*#__PURE__*/__webpack_require__.n(values);

// EXTERNAL MODULE: ./node_modules/lodash/omit.js
var omit = __webpack_require__(20);
...
var isNumber = __webpack_require__(22);
...
// CONCATENATED MODULE: ./src/utils/escapeRegex.js
// escape RegExp special characters https://stackoverflow.com/a/9310752/5142490
var escapeRegex = function escapeRegex(str) {
  return str.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, '\\$&');
};

/* harmony default export */ var utils_escapeRegex = (escapeRegex);
// EXTERNAL MODULE: ./node_modules/invariant/browser.js
var browser = __webpack_require__(7);
var browser_default = /*#__PURE__*/__webpack_require__.n(browser);

// CONCATENATED MODULE: ./src/utils/placeholders.js
/* harmony default export */ var placeholders = ({
  id: '__id__',
  display: '__display__'
});
// CONCATENATED MODULE: ./src/utils/findPositionOfCapturingGroup.js



var findPositionOfCapturingGroup_findPositionOfCapturingGroup = function findPositionOfCapturingGroup(markup, parameterName) {
  browser_default()(parameterName === 'id' || parameterName === 'display', 'Second arg must be either "id" or "display", got: "' + parameterName + '"');
  ...
  browser_default()(indexDisplay !== null || indexId !== null, 'The markup \'' + markup + '\' does not contain either of the placeholders \'__id__\' or \'__display__\'');
...
/* harmony default export */ var utils_findPositionOfCapturingGroup = (findPositionOfCapturingGroup_findPositionOfCapturingGroup);
// CONCATENATED MODULE: ./src/utils/combineRegExps.js


var combineRegExps_combineRegExps = function combineRegExps(regExps) {
  ...
  return new RegExp(regExps.map(function (regex) {
    ...
    browser_default()(!regexFlags, 'RegExp flags are not supported. Change /' + regexString + '/' + regexFlags + ' into /' + regexString + '/');

    return '(' + regexString + ')';
  }).join('|'), 'g');
};

/* harmony default export */ var utils_combineRegExps = (combineRegExps_combineRegExps);
// CONCATENATED MODULE: ./src/utils/countPlaceholders.js
...
/* harmony default export */ var utils_countPlaceholders = (countPlaceholders);
// CONCATENATED MODULE: ./src/utils/iterateMentionsMarkup.js
...
var iterateMentionsMarkup_iterateMentionsMarkup = function iterateMentionsMarkup(value, config, markupIteratee) {
  var textIteratee = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : emptyFn;

  var regex = utils_combineRegExps(config.map(function (c) {
    return c.regex;
  }));
  ...
  var captureGroupOffsets = config.map(function (_ref) {
    ...
    accOffset += utils_countPlaceholders(markup) + 1;
    return result;
  });
  ...
  while ((match = regex.exec(value)) !== null) {
    ...
    var idPos = offset + utils_findPositionOfCapturingGroup(markup, 'id');
    var displayPos = offset + utils_findPositionOfCapturingGroup(markup, 'display');
...
/* harmony default export */ var utils_iterateMentionsMarkup = (iterateMentionsMarkup_iterateMentionsMarkup);
// CONCATENATED MODULE: ./src/utils/getPlainText.js


var getPlainText_getPlainText = function getPlainText(value, config) {
  var result = '';
  utils_iterateMentionsMarkup(value, config, function (match, index, plainTextIndex, id, display) {
    result += display;
  }, function (plainText) {
    result += plainText;
  });
...
/* harmony default export */ var utils_getPlainText = (getPlainText_getPlainText);
// CONCATENATED MODULE: ./src/utils/mapPlainTextIndex.js
...
//   - 'NULL' to return null
var mapPlainTextIndex_mapPlainTextIndex = function mapPlainTextIndex(value, config, indexInPlainText) {
  ...
  utils_iterateMentionsMarkup(value, config, markupIteratee, textIteratee);
...
/* harmony default export */ var utils_mapPlainTextIndex = (mapPlainTextIndex_mapPlainTextIndex);
// CONCATENATED MODULE: ./src/utils/spliceString.js
var spliceString = function spliceString(str, start, end, insert) {
  return str.substring(0, start) + insert + str.substring(end);
};

/* harmony default export */ var utils_spliceString = (spliceString);
// CONCATENATED MODULE: ./src/utils/applyChangeToValue.js
...
var applyChangeToValue_applyChangeToValue = function applyChangeToValue(value, plainTextValue, _ref, config) {
  ...
  var oldPlainTextValue = utils_getPlainText(value, config);
  ...
  var mappedSpliceStart = utils_mapPlainTextIndex(value, config, spliceStart, 'START');
  var mappedSpliceEnd = utils_mapPlainTextIndex(value, config, spliceEnd, 'END');

  var controlSpliceStart = utils_mapPlainTextIndex(value, config, spliceStart, 'NULL');
  var controlSpliceEnd = utils_mapPlainTextIndex(value, config, spliceEnd, 'NULL');
  var willRemoveMention = controlSpliceStart === null || controlSpliceEnd === null;

  var newValue = utils_spliceString(value, mappedSpliceStart, mappedSpliceEnd, insert);

  if (!willRemoveMention) {
    // test for auto-completion changes
    var controlPlainTextValue = utils_getPlainText(newValue, config);
    if (controlPlainTextValue !== plainTextValue) {
      ...
      mappedSpliceStart = utils_mapPlainTextIndex(value, config, spliceStart, 'START');
      mappedSpliceEnd = utils_mapPlainTextIndex(value, config, spliceEnd, 'END');
      newValue = utils_spliceString(value, mappedSpliceStart, mappedSpliceEnd, insert);
    }
  }
...
/* harmony default export */ var utils_applyChangeToValue = (applyChangeToValue_applyChangeToValue);
// CONCATENATED MODULE: ./src/utils/findStartOfMentionInPlainText.js


// For a given indexInPlainText that lies inside a mention,
// returns a the index of of the first char of the mention in the plain text.
// If indexInPlainText does not lie inside a mention, returns indexInPlainText.
var findStartOfMentionInPlainText_findStartOfMentionInPlainText = function findStartOfMentionInPlainText(value, config, indexInPlainText) {
  ...
  utils_iterateMentionsMarkup(value, config, markupIteratee);
...
/* harmony default export */ var utils_findStartOfMentionInPlainText = (findStartOfMentionInPlainText_findStartOfMentionInPlainText);
// CONCATENATED MODULE: ./src/utils/getMentions.js


var getMentions_getMentions = function getMentions(value, config) {
  var mentions = [];
  utils_iterateMentionsMarkup(value, config, function (match, index, plainTextIndex, id, display, childIndex, start) {
    mentions.push({
      id: id,
      display: display,
...
/* harmony default export */ var utils_getMentions = (getMentions_getMentions);
// CONCATENATED MODULE: ./src/utils/countSuggestions.js
...
/* harmony default export */ var utils_countSuggestions = (countSuggestions);
// CONCATENATED MODULE: ./src/utils/getEndOfLastMention.js


var getEndOfLastMention_getEndOfLastMention = function getEndOfLastMention(value, config) {
  var mentions = utils_getMentions(value, config);
  var lastMention = mentions[mentions.length - 1];
  return lastMention ? lastMention.plainTextIndex + lastMention.display.length : 0;
};

/* harmony default export */ var utils_getEndOfLastMention = (getEndOfLastMention_getEndOfLastMention);
// CONCATENATED MODULE: ./src/utils/markupToRegex.js



var markupToRegex_markupToRegex = function markupToRegex(markup) {
  var escapedMarkup = utils_escapeRegex(markup);
  ...
  return new RegExp(escapedMarkup.replace(placeholders.display, '([^' + utils_escapeRegex(charAfterDisplay || '') + ']+?)').replace(placeholders.id, '([^' + utils_escapeRegex(charAfterId || '') + ']+?)'));
};

/* harmony default export */ var utils_markupToRegex = (markupToRegex_markupToRegex);
// CONCATENATED MODULE: ./src/utils/readConfigFromChildren.js





var readConfigFromChildren_readConfigFromChildren = function readConfigFromChildren(children) {
  return react["Children"].toArray(children).map(function (_ref) {
    ...
    return {
      markup: markup,
      regex: regex ? readConfigFromChildren_coerceCapturingGroups(regex, markup) : utils_markupToRegex(markup),
...
var readConfigFromChildren_coerceCapturingGroups = function coerceCapturingGroups(regex, markup) {
  var numberOfGroups = new RegExp(regex.toString() + '|').exec('').length - 1;
  var numberOfPlaceholders = utils_countPlaceholders(markup);

  browser_default()(numberOfGroups === numberOfPlaceholders, 'Number of capturing groups in RegExp ' + regex.toString() + ' (' + numberOfGroups + ') does not match the number of placeholders in the markup \'' + markup + '\' (' + numberOfPlaceholders + ')');

  return regex;
};

/* harmony default export */ var utils_readConfigFromChildren = (readConfigFromChildren_readConfigFromChildren);
// CONCATENATED MODULE: ./src/utils/makeMentionsMarkup.js


var makeMentionsMarkup_makeMentionsMarkup = function makeMentionsMarkup(markup, id, display) {
  return markup.replace(placeholders.id, id).replace(placeholders.display, display);
};

/* harmony default export */ var utils_makeMentionsMarkup = (makeMentionsMarkup_makeMentionsMarkup);
...
// CONCATENATED MODULE: ./src/Suggestion.js
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var Suggestion_Suggestion = (_temp = _class = function (_Component) {
  ...
  Suggestion.prototype.render = function render() {
    var rest = omit_default()(this.props, 'style', keys_default()(Suggestion.propTypes));
...
/* harmony default export */ var src_Suggestion = (styled(Suggestion_Suggestion));
// CONCATENATED MODULE: ./src/LoadingIndicator.js
...
function LoadingIndicator(_ref) {
  ...
  return react_default.a.createElement(
    ...
    react_default.a.createElement(
      'div',
      spinnerStyle,
      react_default.a.createElement('div', spinnerStyle(['element', 'element1'])),
      react_default.a.createElement('div', spinnerStyle(['element', 'element2'])),
      react_default.a.createElement('div', spinnerStyle(['element', 'element3'])),
      react_default.a.createElement('div', spinnerStyle(['element', 'element4'])),
      react_default.a.createElement('div', spinnerStyle(['element', 'element5']))
    )
  );
}

/* harmony default export */ var src_LoadingIndicator = (lib_default()(LoadingIndicator));
// CONCATENATED MODULE: ./src/SuggestionsOverlay.js
var SuggestionsOverlay_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var SuggestionsOverlay_class, SuggestionsOverlay_temp;

function SuggestionsOverlay_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function SuggestionsOverlay_possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function SuggestionsOverlay_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var SuggestionsOverlay_SuggestionsOverlay = (SuggestionsOverlay_temp = SuggestionsOverlay_class = function (_Component) {
  SuggestionsOverlay_inherits(SuggestionsOverlay, _Component);

  function SuggestionsOverlay() {
    SuggestionsOverlay_classCallCheck(this, SuggestionsOverlay);

    return SuggestionsOverlay_possibleConstructorReturn(this, _Component.apply(this, arguments));
  }
  ...
  SuggestionsOverlay.prototype.render = function render() {
    ...
    if (utils_countSuggestions(suggestions) === 0 && !isLoading) {
      return null;
    }

    return react_default.a.createElement(
      'div',
      SuggestionsOverlay_extends({}, style, { onMouseDown: onMouseDown }),
      react_default.a.createElement(
        'ul',
        SuggestionsOverlay_extends({
          ref: function ref(el) {
  ...
  SuggestionsOverlay.prototype.renderSuggestion = function renderSuggestion(result, queryInfo, index) {
    ...
    return react_default.a.createElement(src_Suggestion, {
  ...
  SuggestionsOverlay.prototype.renderLoadingIndicator = function renderLoadingIndicator() {
    ...
    return react_default.a.createElement(src_LoadingIndicator, this.props.style('loadingIndicator'));
  };
...
}(react["Component"]), SuggestionsOverlay_class.propTypes = {
...
}, SuggestionsOverlay_class.defaultProps = {
  suggestions: {},
  onSelect: function onSelect() {
    return null;
  }
}, SuggestionsOverlay_temp);


var SuggestionsOverlay_styled = Object(lib["defaultStyle"])(function (_ref2) {
  var position = _ref2.position;
  return SuggestionsOverlay_extends({
    position: 'absolute',
    zIndex: 1,
...
/* harmony default export */ var src_SuggestionsOverlay = (SuggestionsOverlay_styled(SuggestionsOverlay_SuggestionsOverlay));
// CONCATENATED MODULE: ./src/Highlighter.js
var Highlighter_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var Highlighter_class, Highlighter_temp;
...
function Highlighter_possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function Highlighter_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var Highlighter_Highlighter = (Highlighter_temp = Highlighter_class = function (_Component) {
  Highlighter_inherits(Highlighter, _Component);

  function Highlighter() {
    Highlighter_classCallCheck(this, Highlighter);

    var _this = Highlighter_possibleConstructorReturn(this, _Component.apply(this, arguments));
  ...
  Highlighter.prototype.notifyCaretPosition = function notifyCaretPosition() {
    ...
    if (isEqual_default()(lastPosition, position)) {
      return;
    }
  ...
  Highlighter.prototype.render = function render() {
    ...
    var config = utils_readConfigFromChildren(children);
    ...
    if (selection.start === selection.end) {
      caretPositionInMarkup = utils_mapPlainTextIndex(value, config, selection.start, 'START');
    }
    ...
    var textIteratee = function textIteratee(substr, index, indexInPlainText) {
      ...
      if (isNumber_default()(caretPositionInMarkup) && caretPositionInMarkup >= index && caretPositionInMarkup <= index + substr.length) {
    ...
    utils_iterateMentionsMarkup(value, config, mentionIteratee, textIteratee);
    ...
    return react_default.a.createElement(
      'div',
      Highlighter_extends({}, style, {
        style: Highlighter_extends({}, inputStyle, style.style)
      }),
      resultComponents
    );
  };
  ...
  Highlighter.prototype.renderSubstring = function renderSubstring(string, key) {
    ...
    return react_default.a.createElement(
      'span',
      Highlighter_extends({}, this.props.style('substring'), { key: key }),
      string
    );
  };
  ...
  Highlighter.prototype.renderHighlighterCaret = function renderHighlighterCaret(children) {
    ...
    return react_default.a.createElement(
      'span',
      Highlighter_extends({}, this.props.style('caret'), {
        ref: function ref(el) {
          _this3.caretRef = el;
        },
        key: 'caret'
  ...
  return Highlighter;
}(react["Component"]), Highlighter_class.propTypes = {
  ...
  children: prop_types_default.a.oneOfType([prop_types_default.a.element, prop_types_default.a.arrayOf(prop_types_default.a.element)]).isRequired
}, Highlighter_class.defaultProps = {
  value: '',
  inputStyle: {}
}, Highlighter_temp);


var Highlighter_styled = Object(lib["defaultStyle"])({
  position: 'relative',
  width: 'inherit',
  color: 'transparent',
...
/* harmony default export */ var src_Highlighter = (Highlighter_styled(Highlighter_Highlighter));
// CONCATENATED MODULE: ./src/MentionsInput.js
var MentionsInput_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var MentionsInput_class, MentionsInput_temp, MentionsInput_initialiseProps;

function MentionsInput_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function MentionsInput_possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function MentionsInput_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var MentionsInput_makeTriggerRegex = function makeTriggerRegex(trigger) {
  ...
  if (trigger instanceof RegExp) {
    ...
    var escapedTriggerChar = utils_escapeRegex(trigger);
...
var MentionsInput_MentionsInput = (MentionsInput_temp = MentionsInput_class = function (_React$Component) {
  MentionsInput_inherits(MentionsInput, _React$Component);

  function MentionsInput(props) {
    MentionsInput_classCallCheck(this, MentionsInput);

    var _this = MentionsInput_possibleConstructorReturn(this, _React$Component.call(this, props));

    MentionsInput_initialiseProps.call(_this);
...
}(react_default.a.Component), MentionsInput_class.propTypes = propTypes, MentionsInput_class.defaultProps = {
  singleLine: false,
...
}, MentionsInput_initialiseProps = function _initialiseProps() {
  var _this3 = this;
  ...
  this.getInputProps = function (isTextarea) {
    ...
    var props = omit_default()(_this3.props, 'style', keys_default()(propTypes));

    return MentionsInput_extends({}, props, style('input'), {
  ...
  this.renderInput = function (props) {
    return react_default.a.createElement('input', MentionsInput_extends({ type: 'text', ref: _this3.setInputRef }, props));
  };

  this.renderTextarea = function (props) {
    return react_default.a.createElement('textarea', MentionsInput_extends({ ref: _this3.setInputRef }, props));
  };
  ...
  this.renderSuggestionsOverlay = function () {
    if (!isNumber_default()(_this3.state.selectionStart)) {
      // do not show suggestions when the input does not have the focus
      return null;
    }

    var suggestionsNode = react_default.a.createElement(
      src_SuggestionsOverlay,
      {
    ...
    if (_this3.props.suggestionsPortalHost) {
      return react_dom_default.a.createPortal(suggestionsNode, _this3.props.suggestionsPortalHost);
    } else {
  ...
  this.getPlainText = function () {
    return utils_getPlainText(_this3.props.value || '', utils_readConfigFromChildren(_this3.props.children));
  };
  ...
  this.handleChange = function (ev) {
    ...
    var config = utils_readConfigFromChildren(_this3.props.children);

    var newPlainTextValue = ev.target.value;

    // Derive the new value to set by applying the local change in the textarea's plain text
    var newValue = utils_applyChangeToValue(value, newPlainTextValue, {
    ...
    newPlainTextValue = utils_getPlainText(newValue, config);
    ...
    var startOfMention = utils_findStartOfMentionInPlainText(value, config, selectionStart);
    ...
    var mentions = utils_getMentions(newValue, config);
  ...
  this.handleKeyDown = function (ev) {
    ...
    var suggestionsCount = utils_countSuggestions(_this3.state.suggestions);
    ...
    if (values_default()(KEY).indexOf(ev.keyCode) >= 0) {
      ev.preventDefault();
    }
  ...
  this.updateSuggestionsPosition = function () {
    ...
    var suggestions = react_dom_default.a.findDOMNode(_this3.suggestionsRef);
    var highlighter = react_dom_default.a.findDOMNode(_this3.highlighterRef);
    ...
    if (isEqual_default()(position, _this3.state.suggestionsPosition)) {
      return;
    }
  ...
  this.updateMentionsQueries = function (plainTextValue, caretPosition) {
    ...
    var positionInValue = utils_mapPlainTextIndex(value, config, caretPosition, 'NULL');
    ...
    var substringStartIndex = utils_getEndOfLastMention(value.substring(0, positionInValue), config);
    ...
    react_default.a.Children.forEach(children, function (child, childIndex) {
      ...
      var regex = MentionsInput_makeTriggerRegex(child.props.trigger, _this3.props);
  ...
  this.queryData = function (query, childIndex, querySequenceStart, querySequenceEnd, plainTextValue) {
    var mentionChild = react["Children"].toArray(_this3.props.children)[childIndex];
  ...
  this.updateSuggestions = function (queryId, childIndex, query, querySequenceStart, querySequenceEnd, plainTextValue, results) {
    ...
    _this3.suggestions = MentionsInput_extends({}, _this3.suggestions, (_extends2 = {}, _extends2[childIndex] = {
      queryInfo: {
        childIndex: childIndex,
        query: query,
    ...
    var suggestionsCount = utils_countSuggestions(_this3.suggestions);
    _this3.setState({
  ...
  this.addMention = function (_ref2, _ref3) {
    ...
    var value = _this3.props.value || '';
    var config = utils_readConfigFromChildren(_this3.props.children);
    var mentionsChild = react["Children"].toArray(_this3.props.children)[childIndex];
    ...
    var start = utils_mapPlainTextIndex(value, config, querySequenceStart, 'START');
    var end = start + querySequenceEnd - querySequenceStart;
    var insert = utils_makeMentionsMarkup(markup, id, display);
    if (appendSpaceOnAdd) {
      insert += ' ';
    }
    var newValue = utils_spliceString(value, start, end, insert);
    ...
    var eventMock = { target: { value: newValue } };
    var mentions = utils_getMentions(newValue, config);
    var newPlainTextValue = utils_spliceString(plainTextValue, querySequenceStart, querySequenceEnd, displayValue);
  ...
  this.isLoading = function () {
    var isLoading = false;
    react_default.a.Children.forEach(_this3.props.children, function (child) {
...
var MentionsInput_styled = Object(lib["defaultStyle"])({
  position: 'relative',
  overflowY: 'visible',
...
/* harmony default export */ var src_MentionsInput = (MentionsInput_styled(MentionsInput_MentionsInput));
// CONCATENATED MODULE: ./src/Mention.js




var Mention_styled = Object(lib["defaultStyle"])({
  fontWeight: 'inherit'
});

var Mention = Mention_styled(function (_ref) {
...
/* harmony default export */ var src_Mention = (Mention);
// CONCATENATED MODULE: ./src/index.js
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "MentionsInput", function() { return src_MentionsInput; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "Mention", function() { return src_Mention; });
